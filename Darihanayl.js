/* ============================================================
   BINGO TEXIER - MÓDULO INICIORACHABUENA (V21 - ORIGINAL CORREGIDO)
   ============================================================ */
...
// 2. TRADUCTOR UNIVERSAL DE FECHAS (CORTANDO LA HORA DEL BINGO)
function normalizeDate(str) {
    if (!str) return "00-00-0000";
    return String(str).replace(/\//g, '-').trim().split(' ');
}

// CORRECCIÓN MATEMÁTICA: p=Año, p=Mes, p=Día
