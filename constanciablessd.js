/* ============================================================
   ...
   V8 - LOBBY INTELIGENTE (Se oculta al jugar, Misión Mañana/Hoy, 🎯)
   ============================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // MAGIA DE UX: Ocultar racha al entrar a un juego (Interceptando switchMode)
    setTimeout(() => {
        if (typeof window.switchMode === 'function') {
            ...
            window.switchMode = function(mode) {
                ...
                if (rachaBox) rachaBox.style.display = 'none'; // Se oculta al entrar al juego
            };
        }
