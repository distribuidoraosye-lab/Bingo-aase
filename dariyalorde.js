/* ============================================================
   BINGO TEXIER - MÓDULO INICIORACHABUENA (V21 - CORRECCIÓN EXACTA)
   ============================================================ */
...
// CORRECCIÓN 1: Cortar la hora oculta del Bingo
function normalizeDate(str) {
    if (!str) return "00-00-0000";
    return String(str).replace(/\//g, '-').trim().split(' '); 
}

// CORRECCIÓN 2: Matematica de fechas reparada para no viajar a 1916
...
function renderVisuals(dias, last_active, fecha_inicio, diaSalvado, visualDay, nivelAlcanzadoHoy, nivel_minimo) {
    ...
    if (visualDay === 7 && last_active === currentMasterDate) {
        ...
        // CORRECCIÓN 3: Textos dinámicos solicitados integrados limpiamente
