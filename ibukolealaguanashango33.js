        ...
        db.ref(`bets_torneo_express/${currentDateStr}`).on('value', s => {
            ...
            db.ref('users').once('value', usersSnap => {
                ...
                s.forEach(userNode => {
                    ...
                    const userName = (usersData[uid] && usersData[uid].name) ? usersData[uid].name.split(' ')[0] : 'An\u00FAnimo';
                    ...
                    userNode.forEach(cardNode => {
                        ...
                        allCards.push({ name: userName, hits: hits, id: card.id });
                    });
                });

                allCards.sort((a,b) => b.hits - a.hits);

                allCards.slice(0, 20).forEach((p, index) => {
