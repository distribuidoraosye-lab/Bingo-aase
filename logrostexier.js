/* ============================================================
   ...
   Lógica Pasiva + Visuales Liberados + Vacuna en Compra + Niveles
   ============================================================ */
...
function syncAndRender(uid) {
    ...
    dbRacha.ref(`users/${uid}/racha_data`).once('value', s => {
        ...
        // Evita que la función de compra te resetee al día 1 por culpa de las fechas del Admin.
        ...
        if (diaSalvado) {
            ...
            if (last_active === currentMasterDate) {
                ...
                // PRIMERA COMPRA DEL DÍA (Viene en racha)
