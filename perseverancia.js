/* ============================================================
   ...
   V9 FINAL - LOBBY INTELIGENTE + TASA DINÁMICA + LIMPIEZA DE MEMORIA
   ============================================================ */

const dbRacha = firebase.database();
let configTasa = 35; // Valor por defecto
...
// GESTOR DE ESPÍAS (Para evitar que se crucen los datos de usuarios)
...
dbRacha.ref('config/racha_config/tasa_cambio').on('value', s => {
    if(s.exists()) { configTasa = parseFloat(s.val()); }
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        ...
        // CONTROL DE SESIÓN Y LIMPIEZA DE MEMORIA
        firebase.auth().onAuthStateChanged(user => {
            clearActiveListeners(); // Destruye espías viejos
            
            // Resetea los números a cero
            ...
            if (user) {
                ...
                // Si cierra sesión, poner la pantalla en 0
